...
import MarkdownsAvatar from './MarkdownsAvatar'
  ...
  return <>
    <div className='container mx-auto flex px-5 py-2 mb-10 md:flex-row flex-col items-center'>
      ...
      <div className='w-2/5'>
        ...
        <MarkdownsAvatar className='text-gray-600 dark:text-gray-300' /> 
      </div>
    </div>
  </>;
}

export default MarkdownsHero
